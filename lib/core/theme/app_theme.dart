...
abstract class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      iconTheme: IconThemeData(color: AppColors.onSurfaceLightDim, size: 24),
    ),
    ...
    textTheme: const TextTheme(
      ...
      bodyLarge: TextStyle(fontSize: 16, color: AppColors.onSurfaceLight),
      bodyMedium: TextStyle(fontSize: 14, color: AppColors.onSurfaceLightDim),
      bodySmall: TextStyle(fontSize: 12, color: AppColors.onSurfaceLightDim),
    ),
  );
  ...
  static ThemeData get dark => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      iconTheme: IconThemeData(color: AppColors.onSurfaceDarkDim, size: 24),
    ),
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: AppColors.surfaceDark,
    ...
    textTheme: const TextTheme(
      ...
      bodyLarge: TextStyle(fontSize: 16, color: AppColors.onSurfaceDark),
      bodyMedium: TextStyle(fontSize: 14, color: AppColors.onSurfaceDarkDim),
      bodySmall: TextStyle(fontSize: 12, color: AppColors.onSurfaceDarkDim),
    ),
  );
